...
public class CustomerController {
        ...
        public ResponseEntity<Customer> getCustomer(@PathVariable("id") Integer idCustomer) {
        ...
        public ResponseEntity<Customer> updateCustomerFromDB(@PathVariable("id") Integer idCustomer, @RequestBody Customer customer) {
        ...
        public ResponseEntity<Customer> deleteCustomerFromDB(@PathVariable("id") Integer idCustomer) {
